...
namespace WpfGamesData
{
    public class Game
    {
        ...
        public Game(string sor,char hatarolo)
        {
            ...
            Genre = e[4];
            Publisher = e[5];
            NA_sales = Convert.ToDouble(e[6].Replace('.',','));
            EU_sales = Convert.ToDouble(e[7].Replace('.', ','));
            JP_sales = Convert.ToDouble(e[8].Replace('.', ','));
            Other_sales= Convert.ToDouble(e[9].Replace('.', ','));
            Global_sales = Convert.ToDouble(e[10].Replace('.', ','));
        }
