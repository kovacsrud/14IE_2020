...
namespace WpfKutyaAdapter
{
    ...
    {
        string connString;
        DataTable kutyafajtaadatok;

        public DataView Kutyafajtaadatok { get { return kutyafajtaadatok.DefaultView; } }
        ...
        public FajtaAdapter(string connstring)
        {
            ...
            kutyafajtaadatok = new DataTable();
            ...
            adapter.InsertCommand.CommandText = "insert into kutyafajtak (nev,eredetinev)" +
            ...
            adapter.UpdateCommand.CommandText = "update kutyafajtak" +
                " set nev=@nev,eredetinev=@eredetinev " +
                "where id=@id";
